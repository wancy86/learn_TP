...
<title>联系人|<?php echo ($configcache['Title']); ?></title>
...
$(document).ready(function() {
	...
	contactajax('__APP__/With/winwithajax?Cid=<?php echo ($Cid); ?>');
});
</script>
</head>
<body>
<div id="content" style="margin:0 auto; width:97%;">
    <h3>
    	...
    	<a href="__APP__/Client/clientedit?id=<?php echo ($Cid); ?>">客户资料</a>
    	<a href="__APP__/Client/wincontact?Cid=<?php echo ($Cid); ?>">联系人</a>
        <a href="__APP__/With/winwith?Cid=<?php echo ($Cid); ?>" class="h3a">跟单记录</a>
        <a href="__APP__/With/withadd?Cid=<?php echo ($Cid); ?>" class="add">新增跟单</a>
    </h3>
