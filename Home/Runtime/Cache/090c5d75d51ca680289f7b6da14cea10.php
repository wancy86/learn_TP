...
<title>上传文件|<?php echo ($configcache['Title']); ?></title>
...
<div id="content">
    ...
    <h3>
    	...
    	<a href="__APP__/File/uploadpic?sid=<?php echo ($sid); ?>">上传图片</a>
        <a href="__APP__/File/uploadfile?sid=<?php echo ($sid); ?>" class="h3a">上传文件</a>
        <a href="__APP__/File/fileshare">共享文件</a>
    </h3>
    <dl id="cdl">
    	<dd><font>将自己的文件都上传到文件库，就可在任何地方下载并使用，简单、方便、快捷，可批量上传文件、设置文件名称，最多可同时上传10个文件</font></dd>
        <dd>允许上传的文件类型：<font><?php echo ($filetype); ?></font>&nbsp;&nbsp;&nbsp;&nbsp;单个文件大小限制：<font><?php echo ($filesize); ?> KB</font></dd>
        <dd>
